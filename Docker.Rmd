...
Docker consists of two major components: the Docker client and the Docker Daemon (or "server" or "engine"). Once installed, the client-server connection can be tested with the command "docker version".
